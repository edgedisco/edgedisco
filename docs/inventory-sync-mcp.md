...
On upgrade, retained inventory is seeded before new uploads are accepted. If multiple historical scans share a timestamp and their current membership cannot be reconstructed, that device is omitted until its next inventory upload.
